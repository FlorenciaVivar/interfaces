...
<div align="center" style="display: flex; gap: 10px; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
  <img src="./assets/img/tp1/figma1.png" width="24%" alt="Figma Vista 1">
  <img src="./assets/img/tp1/figma2.png" width="24%" alt="Figma Vista 2">
  <img src="./assets/img/tp1/figma3.png" width="24%" alt="Figma Vista 3">
  <img src="./assets/img/tp1/figma4.png" width="24%" alt="Figma Vista 4">
</div>
...
### Galería de la Web
<div align="center" style="display: flex; gap: 10px; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
  <img src="./assets/img/tp2/tp2.png" width="24%" alt="Web Vista 1">
  <img src="./assets/img/tp2/tp2 (2).png" width="24%" alt="Web Vista 2">
  <img src="./assets/img/tp2/tp2 (3).png" width="24%" alt="Web Vista 3">
  <img src="./assets/img/tp2/tp2 (4).png" width="24%" alt="Web Vista 4">
</div>
...
### Galería del Juego
<div align="center" style="display: flex; gap: 10px; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
  <img src="./assets/img/tp3/tp3.png" width="32%" alt="Juego Vista 1">
  <img src="./assets/img/tp3/tp3 (2).png" width="32%" alt="Juego Vista 2">
  <img src="./assets/img/tp3/tp3 (3).png" width="32%" alt="Juego Vista 3">
    <img src="./assets/img/tp3/tp3 (4).png" width="32%" alt="Juego Vista 3">
</div>

---

##  [Trabajo Práctico 4](https://florenciavivar.github.io/interfaces/tp4/) - Experiencia Inmersiva "Spidey"
...
### Galería de Spidey
<div align="center" style="display: flex; gap: 10px; overflow-x: auto; white-space: nowrap; padding-bottom: 10px;">
  <img src="./assets/img/tp4/tp4.png" width="49%" alt="Spidey Vista 1">
  <img src="./assets/img/tp4/tp4 (2).png" width="49%" alt="Spidey Vista 2">
  <img src="./assets/img/tp4/tp4 (3).png" width="49%" alt="Spidey Vista 3">
  <img src="./assets/img/tp4/tp4 (4).png" width="49%" alt="Spidey Vista 4">
</div>
